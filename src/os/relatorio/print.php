...
<body>
    ...
    <div class="titulo_topo">
        ...
        <div class="servico_descricao">
            ...
            <span class="servico_descricao_titulo"><b>'.$d->titulo.' <small style="font-size:12px">'.$d->tipo.'</small></b></span><br><br>
            '.$d->descricao.'
        </div>
    </div>
    <div class="corpo">
        <h2 class="titulo">'.$d->titulo.' <small style="font-size:16px; color:#a1a1a1">'.$d->tipo.'</small></h2>
